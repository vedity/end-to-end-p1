...
class DatasetClass:
    ...
    def make_dataset_schema(self):
        ...
        cols = 'dataset_name,file_name,file_size,dataset_table_name,dataset_visibility,user_name,dataset_desc,page_name,save_flag' 
        #v1.3
    ...
    def  make_dataset_records(self,dataset_name,file_name,dataset_visibility,user_name,dataset_desc,page_name,method_name,flag):
        ...
        if flag == None:
            ...
            file_name = None
        row=dataset_name,file_name,file_size,dataset_table_name,dataset_visibility,user_name,dataset_desc,page_name,method_name # Make record for dataset table.
    ...
    def make_dataset(self,DBObject,connection,dataset_name,file_name,dataset_visibility,user_name,dataset_desc,page_name,method_name=None,flag=None):
        ...
        row_tuples = self.make_dataset_records(dataset_name,file_name,dataset_visibility,user_name,dataset_desc,page_name,method_name,flag) # Get record for dataset table.
