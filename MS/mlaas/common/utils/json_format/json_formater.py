class JsonFormatClass:
    ...
    def get_schema_format(self,column_name,predicted_datatype):
    ...
    def get_updated_schema_format(self,column_name,changed_column_name,data_type,column_attribute):
        json_data = []
        for x in range(len(column_name)):
            temp_dict = {
                "column_name":changed_column_name[x],
