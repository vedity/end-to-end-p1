...
class TestLogin(unittest.TestCase):
    def test_scenario1_delete_dataset(self):
        ...
        info = {"user_name":"dummy_user","dataset_name":"dataset_tbl","visibility":"private"}
        response = requests.post("http://localhost:8000/mlaas/ingest/create_dataset/",data = info,files = file)
        response = requests.get("http://localhost:8000/mlaas/ingest/create_dataset/",params ={"user_name":"dummy_user"})
        response_data = response.json()
        json_dataset_id = response_data["response"][0]["dataset_id"]
        response = requests.delete("http://localhost:8000/mlaas/ingest/delete/dataset_detail/",params ={"user_name":"dummy_user","dataset_id":json_dataset_id})
...
#         response1 = requests.delete("http://localhost:8000/mlaas/ingest/delete/dataset_detail/",params ={"user_name":"aaa","dataset_id":dataset_id})
#         json_response1 = response1.json()
#         status = json_response1["status_code"]
#         self.assertEqual(status,"500")
...
#         response_datasetid = requests.get("http://localhost:8000/mlaas/ingest/create_dataset/",params ={"user_name":"autouser"})
