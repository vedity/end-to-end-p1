...
main_dag_id = "Cleanup_dag_138389884538933140"
...
master_dict = {'active': 1, 'operation_dict': {1: [3, 4, 5, 6]}, 'values_dict': {1: ['', '', '', '']}, 'schema_id': '1', 'dataset_id': '2', 'project_id': '1', 'save_as': 'False', 'visibility': None, 'dataset_name': None, 'dataset_desc': None, 'user_name': 'abhishek'} 
