...
main_dag_id = "manual_model_dag_138383807454332870"
...
if len(master_dict) != 0:
    ...
    model_hyperparams = master_dict['model_param']

    for model_id,model_name, model_class_name, model_hyperparams in zip(model_id,model_name, model_class_name, model_hyperparams):
