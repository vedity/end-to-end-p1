...
main_dag_id = "manual_model_dag_138394090649834470"
...
master_dict = {'model_id': [11], 'model_name': ['Logistic_Regression'], 'model_hyperparams': [{'C': '0.5', 'penalty': 'l2', 'solver': 'saga'}], 'model_class_name': ['LogisticRegressionClass'], 'algorithm_type': ['Binary']}
