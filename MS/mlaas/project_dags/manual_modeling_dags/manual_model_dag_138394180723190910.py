...
main_dag_id = "manual_model_dag_138394180723190910"
...
master_dict = {'model_id': [2], 'model_name': ['Ridge_Regression'], 'model_hyperparams': [{'alpha': '1', 'solver': 'auto'}], 'model_class_name': ['RidgeRegressionClass'], 'algorithm_type': ['Multi']}
