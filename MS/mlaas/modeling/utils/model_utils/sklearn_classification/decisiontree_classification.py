...
class DecisionTreeClassificationClass:
    ...
    def train_model(self):
        ...
        model = DecisionTreeClassifier(criterion=self.criterion, max_depth=self.max_depth, min_samples_leaf=self.min_samples_leaf,
    ...
    def model_summary(self):
        ...
        model_summary = {"Model Name":"DecisionTree_Classification",
