...
class RandomForestClassificationClass:
    ...
    def train_model(self):
        ...
        model = RandomForestClassifier(n_estimators=self.n_estimators, criterion=self.criterion, max_depth=self.max_depth, 
    ...
    def run_pipeline(self):
        ...
        try :
            ...
            self.MLFlowLogObj.store_model(model, model_name="Random_Forest_Classification", model_type='sklearn')
