...
----CREATED BY----------CREATION DATE--------VERSION--------PURPOSE----------------------
 Brijrajsinh Gohil      2-April-2021           1.0           Initial Version 
...
class KNeighborsRegressionClass:
    ...
    def train_model(self):
        ...
        model = KNeighborsRegressor(n_neighbors=self.n_neighbors,metric=self.metric, algorithm=self.algorithm)  
        # fit the model
    ...
    def model_summary(self):
        ...
        model_summary = {"Model Name":"KNeighobors_Regression",
    ...
    def run_pipeline(self):
        ...
        try :
            ...
            self.MLFlowLogObj.store_model(model, model_name="KNN_Regression_Model", model_type='sklearn')
