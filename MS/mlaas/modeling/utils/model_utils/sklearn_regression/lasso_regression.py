...
class LassoRegressionClass:
    ...
    def train_model(self):
        ...
        # define the model
        model = Lasso(alpha=self.alpha, selection=self.selection) 
        # fit the model
    ...
    def model_summary(self):
        ...
        model_summary = {"Model Name":"ElasticNet_Regression",
                         "Alpha": self.alpha,
    ...
    def run_pipeline(self):
        ...
        try :
            ...
            self.MLFlowLogObj.store_model(model, model_name="Lasso_Regression_Model", model_type='sklearn')
