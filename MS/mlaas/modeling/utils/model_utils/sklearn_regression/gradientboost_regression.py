...
class GradientBoostingRegressionClass:
    ...
    def train_model(self):
        ...
        model = GradientBoostingRegressor(loss=self.loss, learning_rate=self.learning_rate, subsample=self.subsample,
    ...
    def run_pipeline(self):
        ...
        try :
            ...
            self.MLFlowLogObj.store_model(model, model_name="GBM_Regression_Model", model_type='sklearn')
