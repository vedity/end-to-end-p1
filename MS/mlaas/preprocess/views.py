...
class MasterOperationListClass(APIView):
        ...
        def get(self, request, format=None):
                ...
                try:
                        ...
                        response = preprocessObj.get_all_operations() #call get_possible_operation class
                        if isinstance(response,list):  
                                        ...
                                        status_code,error_msg=json_obj.get_Status_code(response) # extract the status_code and error_msg from schema_data
