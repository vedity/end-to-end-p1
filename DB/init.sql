...
Insert into mlaas.activity_master_tbl values (105,41,'Created Experiment','You have created experiment # for project $','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (106,42,'Selected Auto Modeling','You have selected Auto Modeling for experiment # of project $','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (107,43,'Selected Manual Modeling','You have selected Manual Modeling for experiment # of project $','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (108,44,'Defined Modeling Parameters','You have selected the algorithm * and defined the parameters for experiment # of project $','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (109,45,'Started Modeling','Modelling has been started for experiment # of project $','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (110,46,'Stopped Modeling','Modelling has been stopped for experiment # of project $','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (111,47,'Completed Modeling','Modeling of experiment # of project $ has been completed successfully','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (112,48,'Completed Modeling','Modeling of experiment # of project $ has been completed with an error','US','Operation',0,-1,0,0);
