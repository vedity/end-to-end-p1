...
Insert into mlaas.activity_master_tbl values (1,'in_2','Delete Dataset','You have deleted dataset','US','Delete',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (2,'in_3','Create Project','You have created project','US','Create',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (3,'in_1','Create Dataset','You have created dataset','US','Create',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (4,'in_4','Delete Project','You have deleted project','US','Delete',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (5,'sm_5','Column name updated','You have updated the name of Columns','US','Update',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (6,'sm_6','Selected Target Column','You have selected Columns  *  of dataset $ as Target Columns','US','Select',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (7,'sm_7','Ignored Column','You have ignored Columns *','US','Ignore',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (8,'in_8','Created new dataset','You have saved new dataset','US','Create',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (9,'dp_1','Discard Missing Values','operation on column * failed','US','Operation',0,1,0,0);
Insert into mlaas.activity_master_tbl values (10,'dp_1','Discard Missing Values','operation on column * in process','US','Operation',1,1,0,0);
Insert into mlaas.activity_master_tbl values (11,'dp_1','Discard Missing Values','operation on column * completed','US','Operation',2,1,0,0);
Insert into mlaas.activity_master_tbl values (12,'dp_11','Discard Noise','operation on column * failed','US','Operation',0,2,0,0);
Insert into mlaas.activity_master_tbl values (13,'dp_11','Discard Noise','operation on column * in process','US','Operation',1,2,0,0);
Insert into mlaas.activity_master_tbl values (14,'dp_11','Discard Noise','operation on column * completed','US','Operation',2,2,0,0);
Insert into mlaas.activity_master_tbl values (15,'dp_21','Delete Above','operation on column * failed','US','Operation',0,3,1,2);
Insert into mlaas.activity_master_tbl values (16,'dp_21','Delete Above','operation on column * in process','US','Operation',1,3,1,2);
Insert into mlaas.activity_master_tbl values (17,'dp_21','Delete Above','operation on column * completed','US','Operation',2,3,1,2);
Insert into mlaas.activity_master_tbl values (18,'dp_31','Delete Below','operation on column * failed','US','Operation',0,3,1,2);
Insert into mlaas.activity_master_tbl values (19,'dp_31','Delete Below','operation on column * in process','US','Operation',1,3,1,2);
Insert into mlaas.activity_master_tbl values (20,'dp_31','Delete Below','operation on column * completed','US','Operation',2,3,1,2);
Insert into mlaas.activity_master_tbl values (21,'dp_41','Remove Noise','operation on column * failed','US','Operation',0,2,0,0);
Insert into mlaas.activity_master_tbl values (22,'dp_41','Remove Noise','operation on column * in process','US','Operation',1,2,0,0);
Insert into mlaas.activity_master_tbl values (23,'dp_41','Remove Noise','operation on column * completed','US','Operation',2,2,0,0);
Insert into mlaas.activity_master_tbl values (24,'dp_51','Mean Imputation','operation on column * failed','US','Operation',0,1,0,0);
Insert into mlaas.activity_master_tbl values (25,'dp_51','Mean Imputation','operation on column * in process','US','Operation',1,1,0,0);
Insert into mlaas.activity_master_tbl values (26,'dp_51','Mean Imputation','operation on column * completed','US','Operation',2,1,0,0);
Insert into mlaas.activity_master_tbl values (27,'dp_61','Median Imputation','operation on column * failed','US','Operation',0,1,0,0);
Insert into mlaas.activity_master_tbl values (28,'dp_61','Median Imputation','operation on column * in process','US','Operation',1,1,0,0);
Insert into mlaas.activity_master_tbl values (29,'dp_61','Median Imputation','operation on column * completed','US','Operation',2,1,0,0);
Insert into mlaas.activity_master_tbl values (30,'dp_71','Mode Imputation','operation on column * failed','US','Operation',0,1,0,0);
Insert into mlaas.activity_master_tbl values (31,'dp_71','Mode Imputation','operation on column * in process','US','Operation',1,1,0,0);
Insert into mlaas.activity_master_tbl values (32,'dp_71','Mode Imputation','operation on column * completed','US','Operation',2,1,0,0);
Insert into mlaas.activity_master_tbl values (33,'dp_81','Arbitarry Value Imputation','operation on column * failed','US','Operation',0,1,1,2);
Insert into mlaas.activity_master_tbl values (34,'dp_81','Arbitarry Value Imputation','operation on column * in process','US','Operation',1,1,1,2);
Insert into mlaas.activity_master_tbl values (35,'dp_81','Arbitarry Value Imputation','operation on column * completed','US','Operation',2,1,1,2);
Insert into mlaas.activity_master_tbl values (36,'dp_91','End_or_Tail Imputation','operation on column * failed','US','Operation',0,1,0,0);
Insert into mlaas.activity_master_tbl values (37,'dp_91','End_or_Tail Imputation','operation on column * in process','US','Operation',1,1,0,0);
Insert into mlaas.activity_master_tbl values (38,'dp_91','End_or_Tail Imputation','operation on column * completed','US','Operation',2,1,0,0);
Insert into mlaas.activity_master_tbl values (39,'dp_101','Frequent Category Imputation','operation on column * failed','US','Operation',0,1,0,0);
Insert into mlaas.activity_master_tbl values (40,'dp_101','Frequent Category Imputation','operation on column * in process','US','Operation',1,1,0,0);
Insert into mlaas.activity_master_tbl values (41,'dp_101','Frequent Category Imputation','operation on column * completed','US','Operation',2,1,0,0);
Insert into mlaas.activity_master_tbl values (42,'dp_111','Add Missing Category','operation on column * failed','US','Operation',0,1,1,3);
Insert into mlaas.activity_master_tbl values (43,'dp_111','Add Missing Category','operation on column * in process','US','Operation',1,1,1,3);
Insert into mlaas.activity_master_tbl values (44,'dp_111','Add Missing Category','operation on column * completed','US','Operation',2,1,1,3);
Insert into mlaas.activity_master_tbl values (45,'dp_121','Random Sample Imputation','operation on column * failed','US','Operation',0,1,0,0);
Insert into mlaas.activity_master_tbl values (46,'dp_121','Random Sample Imputation','operation on column * in process','US','Operation',1,1,0,0);
Insert into mlaas.activity_master_tbl values (47,'dp_121','Random Sample Imputation','operation on column * completed','US','Operation',2,1,0,0);
Insert into mlaas.activity_master_tbl values (48,'dp_131','Replace Noise with Mean','operation on column * failed','US','Operation',0,2,0,0);
Insert into mlaas.activity_master_tbl values (49,'dp_131','Replace Noise with Mean','operation on column * in process','US','Operation',1,2,0,0);
Insert into mlaas.activity_master_tbl values (50,'dp_131','Replace Noise with Mean','operation on column * completed','US','Operation',2,2,0,0);
Insert into mlaas.activity_master_tbl values (51,'dp_141','Replace Noise with Median','operation on column * failed','US','Operation',0,2,0,0);
Insert into mlaas.activity_master_tbl values (52,'dp_141','Replace Noise with Median','operation on column * in process','US','Operation',1,2,0,0);
Insert into mlaas.activity_master_tbl values (53,'dp_141','Replace Noise with Median','operation on column * completed','US','Operation',2,2,0,0);
Insert into mlaas.activity_master_tbl values (54,'dp_151','Replace Noise with Mode','operation on column * failed','US','Operation',0,2,0,0);
Insert into mlaas.activity_master_tbl values (55,'dp_151','Replace Noise with Mode','operation on column * in process','US','Operation',1,2,0,0);
Insert into mlaas.activity_master_tbl values (56,'dp_151','Replace Noise with Mode','operation on column * completed','US','Operation',2,2,0,0);
Insert into mlaas.activity_master_tbl values (57,'dp_161','Replace Noise with End_or_Tail Value','operation on column * failed','US','Operation',0,2,0,0);
Insert into mlaas.activity_master_tbl values (58,'dp_161','Replace Noise with End_or_Tail Value','operation on column * in process','US','Operation',1,2,0,0);
Insert into mlaas.activity_master_tbl values (59,'dp_161','Replace Noise with End_or_Tail Value','operation on column * completed','US','Operation',2,2,0,0);
Insert into mlaas.activity_master_tbl values (60,'dp_171','Replace Noise with Random Value','operation on column * failed','US','Operation',0,2,0,0);
Insert into mlaas.activity_master_tbl values (61,'dp_171','Replace Noise with Random Value','operation on column * in process','US','Operation',1,2,0,0);
Insert into mlaas.activity_master_tbl values (62,'dp_171','Replace Noise with Random Value','operation on column * completed','US','Operation',2,2,0,0);
Insert into mlaas.activity_master_tbl values (63,'dp_181','Replace Noise with Arbitry Value','operation on column * failed','US','Operation',0,2,1,2);
Insert into mlaas.activity_master_tbl values (64,'dp_181','Replace Noise with Arbitry Value','operation on column * in process','US','Operation',1,2,1,2);
Insert into mlaas.activity_master_tbl values (65,'dp_181','Replace Noise with Arbitry Value','operation on column * completed','US','Operation',2,2,1,2);
Insert into mlaas.activity_master_tbl values (66,'dp_191','Remove outliers with Extreme Value analysis','operation on column * failed','US','Operation',0,3,0,0);
Insert into mlaas.activity_master_tbl values (67,'dp_191','Remove outliers with Extreme Value analysis','operation on column * in process','US','Operation',1,3,0,0);
Insert into mlaas.activity_master_tbl values (68,'dp_191','Remove outliers with Extreme Value analysis','operation on column * completed','US','Operation',2,3,0,0);
Insert into mlaas.activity_master_tbl values (69,'dp_201','Remove outliers with Z-score Detection Method','operation on column * failed','US','Operation',0,3,0,0);
Insert into mlaas.activity_master_tbl values (70,'dp_201','Remove outliers with Z-score Detection Method','operation on column * in process','US','Operation',1,3,0,0);
Insert into mlaas.activity_master_tbl values (71,'dp_201','Remove outliers with Z-score Detection Method','operation on column * completed','US','Operation',2,3,0,0);
Insert into mlaas.activity_master_tbl values (72,'dp_211','Replace Outliers with Mean using Extreme Value Analysis Detection','operation on column * failed','US','Operation',0,3,0,0);
Insert into mlaas.activity_master_tbl values (73,'dp_211','Replace Outliers with Mean using Extreme Value Analysis Detection','operation on column * in process','US','Operation',1,3,0,0);
Insert into mlaas.activity_master_tbl values (74,'dp_211','Replace Outliers with Mean using Extreme Value Analysis Detection','operation on column * completed','US','Operation',2,3,0,0);
Insert into mlaas.activity_master_tbl values (75,'dp_221','Replace Outliers with Mean using Z-score Detection','operation on column * failed','US','Operation',0,3,0,0);
Insert into mlaas.activity_master_tbl values (76,'dp_221','Replace Outliers with Mean using Z-score Detection','operation on column * in process','US','Operation',1,3,0,0);
Insert into mlaas.activity_master_tbl values (77,'dp_221','Replace Outliers with Mean using Z-score Detection','operation on column * completed','US','Operation',2,3,0,0);
Insert into mlaas.activity_master_tbl values (78,'dp_231','Replace Outliers with Median using Extreme Value Analysis Detection','operation on column * failed','US','Operation',0,3,0,0);
Insert into mlaas.activity_master_tbl values (79,'dp_231','Replace Outliers with Median using Extreme Value Analysis Detection','operation on column * in process','US','Operation',1,3,0,0);
Insert into mlaas.activity_master_tbl values (80,'dp_231','Replace Outliers with Median using Extreme Value Analysis Detection','operation on column * completed','US','Operation',2,3,0,0);
Insert into mlaas.activity_master_tbl values (81,'dp_241','Replace Outliers with Median using Z-score Detection','operation on column * failed','US','Operation',0,3,0,0);
Insert into mlaas.activity_master_tbl values (82,'dp_241','Replace Outliers with Median using Z-score Detection','operation on column * in process','US','Operation',1,3,0,0);
Insert into mlaas.activity_master_tbl values (83,'dp_241','Replace Outliers with Median using Z-score Detection','operation on column * completed','US','Operation',2,3,0,0);
...
Insert into mlaas.activity_master_tbl values (84,'dp_251','Logarithmic transformation','operation on column * failed','US','Operation',0,7,0,0);
Insert into mlaas.activity_master_tbl values (85,'dp_251','Logarithmic transformation','operation on column * in process','US','Operation',1,7,0,0);
Insert into mlaas.activity_master_tbl values (86,'dp_251','Logarithmic transformation','operation on column * completed','US','Operation',2,7,0,0);
Insert into mlaas.activity_master_tbl values (84,'dp_252','Square root transformation','operation on column * failed','US','Operation',0,7,0,0);
Insert into mlaas.activity_master_tbl values (85,'dp_252','Square root transformation','operation on column * in process','US','Operation',1,7,0,0);
Insert into mlaas.activity_master_tbl values (86,'dp_252','Square root transformation','operation on column * completed','US','Operation',2,7,0,0);
Insert into mlaas.activity_master_tbl values (84,'dp_253','Reciprocal transformation','operation on column * failed','US','Operation',0,7,0,0);
Insert into mlaas.activity_master_tbl values (85,'dp_253','Reciprocal transformation','operation on column * in process','US','Operation',1,7,0,0);
Insert into mlaas.activity_master_tbl values (86,'dp_253','Reciprocal transformation','operation on column * completed','US','Operation',2,7,0,0);
Insert into mlaas.activity_master_tbl values (84,'dp_254','Power transformation','operation on column * failed','US','Operation',0,7,1,2);
Insert into mlaas.activity_master_tbl values (85,'dp_254','Power transformation','operation on column * in process','US','Operation',1,7,1,2);
Insert into mlaas.activity_master_tbl values (86,'dp_254','Power transformation','operation on column * completed','US','Operation',2,7,1,2);
Insert into mlaas.activity_master_tbl values (84,'dp_255','Box-Cox Transformation','operation on column * failed','US','Operation',0,7,0,0);
Insert into mlaas.activity_master_tbl values (85,'dp_255','Box-Cox Transformation','operation on column * in process','US','Operation',1,7,0,0);
Insert into mlaas.activity_master_tbl values (86,'dp_255','Box-Cox Transformation','operation on column * completed','US','Operation',2,7,0,0);
Insert into mlaas.activity_master_tbl values (84,'dp_256','Yeo-Johnson Transformation','operation on column * failed','US','Operation',0,7,0,0);
Insert into mlaas.activity_master_tbl values (85,'dp_256','Yeo-Johnson Transformation','operation on column * in process','US','Operation',1,7,0,0);
Insert into mlaas.activity_master_tbl values (86,'dp_256','Yeo-Johnson Transformation','operation on column * completed','US','Operation',2,7,0,0);
Insert into mlaas.activity_master_tbl values (87,'dp_261','Label Encoding','operation on column * failed','US','Operation',0,5,0,0);
Insert into mlaas.activity_master_tbl values (88,'dp_261','Label Encoding','operation on column * in process','US','Operation',1,5,0,0);
Insert into mlaas.activity_master_tbl values (89,'dp_261','Label Encoding','operation on column * completed','US','Operation',2,5,0,0);
Insert into mlaas.activity_master_tbl values (90,'dp_271','One Hot Encoding','operation on column * failed','US','Operation',0,5,0,0);
Insert into mlaas.activity_master_tbl values (91,'dp_271','One Hot Encoding','operation on column * in process','US','Operation',1,5,0,0);
Insert into mlaas.activity_master_tbl values (92,'dp_271','One Hot Encoding','operation on column * completed','US','Operation',2,5,0,0);
Insert into mlaas.activity_master_tbl values (93,'dp_281','Add to Column','operation on column * failed','US','Operation',0,6,1,2);
Insert into mlaas.activity_master_tbl values (94,'dp_281','Add to Column','operation on column * in process','US','Operation',1,6,1,2);
Insert into mlaas.activity_master_tbl values (95,'dp_281','Add to Column','operation on column * completed','US','Operation',2,6,1,2);
Insert into mlaas.activity_master_tbl values (96,'dp_291','Subtract from Column','operation on column * failed','US','Operation',0,6,1,2);
Insert into mlaas.activity_master_tbl values (97,'dp_291','Subtract from Column','operation on column * in process','US','Operation',1,6,1,2);
Insert into mlaas.activity_master_tbl values (98,'dp_291','Subtract from Column','operation on column * completed','US','Operation',2,6,1,2);
Insert into mlaas.activity_master_tbl values (99,'dp_301','Divide from column','operation on column * failed','US','Operation',0,6,1,5);
Insert into mlaas.activity_master_tbl values (100,'dp_301','Divide from column','operation on column * in process','US','Operation',1,6,1,5);
Insert into mlaas.activity_master_tbl values (101,'dp_301','Divide from column','operation on column * completed','US','Operation',2,6,1,5);
...
Insert into mlaas.activity_master_tbl values (108,'md_44','Defined Modeling Parameters','You have selected the algorithm "*" and defined the parameters for experiment "#" of project "$"','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (109,'md_45','Started Modeling','Modelling has been started for experiment "#" of project "$"','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (110,'md_46','Stopped Modeling','Modelling has been stopped for experiment "#" of project "$"','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (111,'md_47','Completed Modeling','Modeling of experiment "#" has been completed successfully','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (112,'md_48','Completed Modeling','Modeling of experiment "#" has been completed with an error','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (113,'ss_1','Started Scale And Split','Scaling and Spliting of * has been started','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (114,'ss_2','Completed Scale And Split','Scaling and Spliting of * has been completed','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (115,'cl_1','Cleanup Started','Cleanup started for dataset * of project &','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (116,'cl_2','Cleanup Ended','Cleanup ended for dataset * of project &','US','Operation',0,-1,0,0);
Insert into mlaas.activity_master_tbl values (117,'cl_3','Dataset Created','You have created New dataset *','US','Operation',0,-1,0,0);
