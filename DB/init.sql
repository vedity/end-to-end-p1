...
Insert into mlaas.activity_master_tbl values (84,'dp_251','Apply Log Transformation','operation on column * failed','US','Operation',0,3,0,0);
Insert into mlaas.activity_master_tbl values (85,'dp_251','Apply Log Transformation','operation on column * in process','US','Operation',1,3,0,0);
Insert into mlaas.activity_master_tbl values (86,'dp_251','Apply Log Transformation','operation on column * completed','US','Operation',2,3,0,0);
